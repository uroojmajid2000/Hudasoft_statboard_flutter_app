...
class MyTextFieldTeam extends StatefulWidget {
  ...
  @override
  State<MyTextFieldTeam> createState() => _MyTextFieldTeamState();
}

class _MyTextFieldTeamState extends State<MyTextFieldTeam> {
  bool show = true;
